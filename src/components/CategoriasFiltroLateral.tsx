    ...
    >
      ...
      <div style={{ margin: '48px auto 0', textAlign: 'center' }}>
        {chaveBanner === 'banner-lateral-mousepads' ? (
          <a
            href={bannerLateralMousepadLink || "https://wa.me/5562981316462?text=Ol%C3%A1!%20Quero%20saber%20mais%20sobre%20como%20funciona%20para%20personalizar%20uma%20desckpad."}
            target="_blank"
