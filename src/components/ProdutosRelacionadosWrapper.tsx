...
interface ProdutosRelacionadosWrapperProps {
  produtoAtual: {
    id: string
    categoria: string
    tipo: string
...
export default function ProdutosRelacionadosWrapper({ produtoAtual, children }: ProdutosRelacionadosWrapperProps) {
  ...
  return (
    <div>
      ...
      {!loading && produtosRelacionados.length > 0 && (
        <div className="mt-16">
